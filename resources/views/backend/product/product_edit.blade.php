                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="form-group col-sm-10">
                            <input type="text" name="name" value="{{ $product->name }}" class="form-control"id="name-input">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="unit_id" class="form-select" aria-label="Default select example">
                                ...
                                <option value="{{$unit->id}}" {{$unit->id == $product->unit_id
                    ...
                    <div class="row mb-3">
                        ...
                        <input type="submit" class="btn btn-success waves-effect waves-light" value="Update Product">
                    </form><!-- end row -->
                </div>
            </div>
        </div> <!-- end col -->
