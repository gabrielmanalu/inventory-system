                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="form-group col-sm-10">
                            <input type="text" name="name"class="form-control"id="name-input" value="{{ $supplier->name }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="mobile_number-input" class="col-sm-2 col-form-label">Mobile Number</label>
                        <div class="form-group col-sm-10">
                            <input type="text" name="mobile_number"class="form-control"id="mobile_number-input" value="{{ $supplier->mobile_number }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="email-input" class="col-sm-2 col-form-label">Email</label>
                        <div class="form-group col-sm-10">
                            <input type="text" name="email"class="form-control"id="email-input" value="{{ $supplier->email }}">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label for="address-input" class="col-sm-2 col-form-label">Address</label>
                        <div class="form-group col-sm-10">
                            <input type="text" name="address"class="form-control"id="address-input" value="{{ $supplier->address }}">
                        </div>
                    </div>
