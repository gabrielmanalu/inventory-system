                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="form-group col-sm-10">
                            <input type="text" name="name"class="form-control"id="name-input" value="{{ $unit->name }}">
                        </div>
                    </div>
                        <input type="submit" class="btn btn-success waves-effect waves-light" value="Edit Unit">
                    </form><!-- end row -->
                </div>
            </div>
        </div> <!-- end col -->
